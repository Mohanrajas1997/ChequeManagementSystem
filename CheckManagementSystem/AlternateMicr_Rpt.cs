...
{
    public partial class AlternateMicr_Rpt : Form
    {
       public int previousSelectedRow = -1;
        ...
        public AlternateMicr_Rpt()
        {
            InitializeComponent();
        }


        private void AlternateMicr_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void btnref_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string BankName = AlternateMicrCode_Txt.Text.Trim();
                string BranchName = cmbbrcode.SelectedValue.ToString();
                string ConditionStatus = "";

                if (MicrCode != "")
                {
                    ConditionStatus = " where a.micr_code =" + "'" + MicrCode + "'";
                ...
                if (BankName != "")
                {
                    if (ConditionStatus !="")
                    {
                        ConditionStatus += "and a.alternate_micr =" + "'" + BankName + "'";
                    }
                    else
                    {
                        ConditionStatus = " where a.alternate_micr=" + "'" + BankName + "'";
                    }
                }
                if (BranchName != "")
                {
                     if (ConditionStatus !="")
                    {
                        ConditionStatus += "and b.branch_code =" + "'" + BranchName + "'";
                    }
                    else
                    {
                        ConditionStatus = " where b.branch_code=" + "'" + BranchName + "'";
                    }
                }
                ...
                dt = Obj.AlternateMicrMasterRpt(ConditionStatus);
        ...
        private void lstbtngen_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                workbook.SaveAs(root + "AlternateMicr_Rpt" + ".xls", Type.Missing, Type.Missing, Type.Missing, Type.Missing, Type.Missing, Microsoft.Office.Interop.Excel.XlSaveAsAccessMode.xlExclusive, Type.Missing, Type.Missing, Type.Missing, Type.Missing);
        ...
        private void AlternateMicr_KeyDown(object sender, KeyEventArgs e)
        {
