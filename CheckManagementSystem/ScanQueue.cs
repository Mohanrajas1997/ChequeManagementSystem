...
{
    public partial class ScanQueue : Form
    {
        ...
        private void LoadBatchdetails(string ConditionStatus)
        {
            try
            {
                ...
                dtscanning = ObjInward.GetScanDetails(ConditionStatus);
                ...
                {
                    MessageBox.Show("No Scanning List Available for Maker Validation", "Check Management System", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
        ...
        private void gvscanlist_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                if (gvscanlist.Columns[e.ColumnIndex].Name == "Action")
                {
                    ...
                    MakerScreen objcheck = new MakerScreen(Batchgid, BatchDate, BatchNo, ChequeType, DepositSlipNo, Pickuplocation, ChequeCount, CustomerName, batchamount);
