...
{
    public partial class MicrUpdate : Form
    {
        public int Chqid = 0;
        ...
        public MicrUpdate(int BatchGid, int ChqGid, string MicrCode, string ChqNo, string Chq_Type)
        {
            InitializeComponent();
            Batchid = BatchGid;
            Chqid = ChqGid;
            ...
            try
            {
                if (DialogResult.Yes == MessageBox.Show("Are you sure you want to save the record?", "", MessageBoxButtons.YesNo))
                {
                    ...
                    else
                    {
                        ...
                        string[] result = objBusiness.UpdateMicrCode(Chqid, NewMicrCode);
