...
namespace CheckManagementSystem
{
    public partial class MakerScreen : Form
    {
        ...
        public MakerScreen(int Batchgid, string BatchDate, string BatchNo, string ChequeType, string DepositSlipNo, string Pickuplocation, int ChequeCount, string CustomerName, double batchamount)
        {
        ...
        private void LoadMicrDtl(int BatchGid)
        {
            try
            {
                ...
                dtscanning = ObjInward.GetMicrDetails(BatchGid);
        ...
        private void showchq(int row)
        {
            ...
            MicrEntry objcheck = new MicrEntry(BatchGid, Chqgid, MicrCode, ChqNo, ChqType);
            objcheck.Top = this.Top + pnlGrid.Top + pnlGrid.Height - objcheck.Height;
