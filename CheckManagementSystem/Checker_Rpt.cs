...
{
    public partial class Checker_Rpt : Form
    {
        ...
        private void btnref_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                dt = Obj.CheckerRpt(ConditionStatus);
        ...
        private void lstbtngen_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                workbook.SaveAs(root + "Checker_Rpt" + ".xls", Type.Missing, Type.Missing, Type.Missing, Type.Missing, Type.Missing, Microsoft.Office.Interop.Excel.XlSaveAsAccessMode.xlExclusive, Type.Missing, Type.Missing, Type.Missing, Type.Missing);
