...
{
    public partial class LocationMst_Rpt : Form
    {
        ...
        private void btnref_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                string LocationCode = LocationCode_Txt.Text.Trim();
                string PickupPoint = PickupPoint_Txt.Text.Trim();
                string ConditionStatus = "";

                if (LocationCode != "")
                {
                    ConditionStatus = " where LOCATION_CODE =" + "'" + LocationCode + "'";
                ...
                if (PickupPoint != "")
                {
                    if (ConditionStatus !="")
                    {
                        ConditionStatus += "and PICKUP_LOCATION =" + "'" + PickupPoint + "'";
                    }
                    else
                    {
                        ConditionStatus = " where PICKUP_LOCATION=" + "'" + PickupPoint + "'";
                    }
                }
                if (ConditionStatus=="")
                {
                ...
                dt = Obj.PickupPointRpt(ConditionStatus);
        ...
        private void lstbtngen_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                worksheet.Name = "Location Master";
                ...
                workbook.SaveAs(root + "LocationMaster_Rpt" + ".xls", Type.Missing, Type.Missing, Type.Missing, Type.Missing, Type.Missing, Microsoft.Office.Interop.Excel.XlSaveAsAccessMode.xlExclusive, Type.Missing, Type.Missing, Type.Missing, Type.Missing);
