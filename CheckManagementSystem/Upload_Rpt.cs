...
{
    public partial class Upload_Rpt : Form
    {
       string root = string.Empty;
        ...
        private void Upload_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                dtBranch = objinward.GetBranches();
        ...
        private void btnref_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    ConditionStatus = " and a.upload_date >=" + "'" + InwardFromdate + "' and a.upload_date <=" + "'" + InwardTodate + "'";
                ...
                {
                    ConditionStatus += "and a.branch_code =" + "'" + cmbBranch.SelectedValue.ToString() + "'";
                }
                ...
                if (StatusCode != "")
                {
                     if (ConditionStatus !="")
                    {
                        ...
                        {
                            ConditionStatus += "and a.upload_queue_code ='C'";
                        }
                        else if (cmbStatus.Text == "Delete")
                        {
                            ConditionStatus += "and a.upload_queue_code ='D'";
                        }
                ...
                dt = Obj.UploadRpt(ConditionStatus);
                gvuploadgrid.DataSource = dt;

                gvuploadgrid.Columns["Total Chq Count"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
                gvuploadgrid.Columns["Total Batch Amount"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
                gvuploadgrid.Columns["Valid Chq Count"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
                gvuploadgrid.Columns["Valid Batch Amount"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
                gvuploadgrid.Columns["Disc Chq Count"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
                gvuploadgrid.Columns["Disc Batch Amount"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
                gvuploadgrid.Columns["Disc Micr Count"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
                gvuploadgrid.Columns["Inward Gid"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
                gvuploadgrid.Columns["Upload Gid"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight; 
            }
            catch (Exception ex)
            {
                //LogHelper.WriteLog(ex.ToString());
        ...
        private void lstbtngen_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                workbook.SaveAs(root + "Upload_Rpt" + ".xls", Type.Missing, Type.Missing, Type.Missing, Type.Missing, Type.Missing, Microsoft.Office.Interop.Excel.XlSaveAsAccessMode.xlExclusive, Type.Missing, Type.Missing, Type.Missing, Type.Missing);
