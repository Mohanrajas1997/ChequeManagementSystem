...
{
    public partial class ScanChq : Form
    {
        #region variables
        MySqlConnection con;
        ...
        public ScanChq(int Batchgid,string _branch_code, string BatchDate, string BatchNo, string ChequeType, string DepositSlipNo, string Pickuplocation, int ChequeCount, string CustomerName, double batchamount)
        {
            InitializeComponent();
            batchid = Batchgid;
            chq_type = ChequeType;
        ...
        private void disp_image()
        {
            ...
            streamBmpImg = new MemoryStream((byte[])dtScan.Rows[Convert.ToInt32(lblScanSerialNo.Tag) - 1][fld_image]);
            bitImg = new Bitmap(Image.FromStream(streamBmpImg));
            //assign that bitmap object to the picture box
            picChq.Image = bitImg;
        ...
        private void ScanChq_SizeChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                dgvScan.Width = this.Width - (pnlBatch.Left + pnlBatch.Width + 32);
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            {
                int i = Convert.ToInt32(lblScanSerialNo.Tag) - 1;
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            for (i = 0; i < dtScan.Rows.Count; i++)
            {
                ...
                cmd.Parameters.Add("out_chq_gid", MySqlDbType.Int32);
                cmd.Parameters.Add("out_msg", MySqlDbType.VarChar);
                cmd.Parameters.Add("out_result", MySqlDbType.Int32);

                cmd.Parameters["out_chq_gid"].Direction = ParameterDirection.Output;
                ...
                chq_gid = (int)cmd.Parameters["out_chq_gid"].Value;
